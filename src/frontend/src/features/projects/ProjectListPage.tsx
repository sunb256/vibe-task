      ...
      >
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          {projects.map((project) => (
            <article
              key={project.id}
              className="rounded-[2rem] border border-[var(--border)] bg-[var(--panel)] p-5 shadow-[0_18px_50px_rgba(31,43,46,0.08)] backdrop-blur"
            >
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="inline-flex rounded-full border border-[var(--border)] px-4 py-2 text-sm font-semibold text-[var(--accent)] transition hover:border-[var(--accent)] hover:bg-[var(--accent)]/8"
                >
                  Open Project
                </Link>
              </div>
